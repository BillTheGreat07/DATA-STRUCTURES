...
// Επιστρέφει το μέγεθος ενός κόμβου αν υπάρχει, διαφορετικά NULL

int node_size(SetNode node) {
...
void update_size(SetNode node) {
    if(node != NULL) node->size = 1 + node_size(node->left) + node_size(node->right);
}
